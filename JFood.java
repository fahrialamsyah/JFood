...
public class JFood
{
    ...
    public static void main(String[] args)
    {
       ...
       // Object Customer Tugas 3
        ...
        CashInvoice cash1 = new CashInvoice(10, food2, customer1, InvoiceStatus.Finished);
        CashInvoice cash2 = new CashInvoice(11, food1, customer2, InvoiceStatus.Finished,50000);
       
        CashlessInvoice cashless1 = new CashlessInvoice(12, food2,customer1,InvoiceStatus.Finished,promo1);
        CashlessInvoice cashless2 = new CashlessInvoice(13, food1, customer2,InvoiceStatus.Finished,promo2);
